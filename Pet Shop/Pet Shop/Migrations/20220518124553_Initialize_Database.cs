    ...
    public partial class Initialize_Database : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "ad376a8f", "561b2a00-47fe-4637-9abd-5f9adc766aa5", "Admin", "Admin" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "a18be9c0", 0, "b3969f1b-643c-40b3-b749-8aa8454833e1", "admin@gmail.com", false, false, null, "admin@gmail.com", "admin", "AQAAAAEAACcQAAAAENnaqR3IFVI7Q+RNRS8yVzlJMA9cb68uU0Us0ysKSGAOq2OuYvDsVjoxFanX4Emsow==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                table: "Rates",
                columns: new[] { "RateId", "RateValue", "UserId" },
                values: new object[,]
                {
                    { 2, 5, 0 },
                    { 1, 4, 0 },
            ...
            migrationBuilder.InsertData(
                table: "CartProducts",
                columns: new[] { "CartId", "ProdactId", "Amount" },
                values: new object[,]
                {
                    { 1, 1, 3 },
                    { 3, 1, 1 },
