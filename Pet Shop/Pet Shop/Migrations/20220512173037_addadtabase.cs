...
{
    public partial class addadtabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnimalProducts", x => x.AnimalProdactId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AnimalProdactId = table.Column<int>(type: "int", nullable: false),
                    CartId = table.Column<int>(type: "int", nullable: false),
                    AnimalProdactsAnimalProdactId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartAnimalProducts", x => new { x.CartId, x.AnimalProdactId });
                    table.ForeignKey(
                        name: "FK_CartAnimalProducts_AnimalProducts_AnimalProdactsAnimalProdactId",
                        column: x => x.AnimalProdactsAnimalProdactId,
                        principalTable: "AnimalProducts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartAnimalProducts_AnimalProdactsAnimalProdactId",
                table: "CartAnimalProducts",
                column: "AnimalProdactsAnimalProdactId");
